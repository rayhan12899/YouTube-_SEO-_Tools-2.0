...
export const translations = {
  en: {
    ...
    heroTitle: "Create Viral Content",
    ...
    quotaExhausted: "Daily API quota exhausted. Please try again tomorrow or use your own API key in Settings.",
    ...
    popularCategories: "Popular Categories (10 Topics)",
    liveInsights: "Live Creator Insights",
    processingPower: "AI Compute Power",
    threatLevel: "Noise Interference Level",
    uptime: "System Uptime",
    generatingInsight: "Syncing with global trends...",
    ...
    audienceKids: "Kids & Family",
    audienceTech: "Tech Enthusiasts",
    audienceBusiness: "Business Professionals",
    audienceCreative: "Creative Souls",
    pacing: "Content Pacing",
    pacingFast: "Fast & Energetic",
    pacingSteady: "Balanced & Steady",
    pacingRelaxed: "Slow & Relaxed",
    narrativeStrategy: "Narrative Strategy",
    strategyEducational: "Educational",
    strategyStorytelling: "Storytelling",
    strategyInterview: "Interview Style",
    strategyFirstPerson: "First Person Vlog",
    strategyListicle: "Listicle / Top 10",
    deepSearch: "Deep AI Context Search",
    settings: "Settings",
  ...
  bn: {
    title: "YouTube Creator Studio",
    subtitle: "নেক্সট-জেন স্টুডিও | V3.0",
    home: "হোম",
    ...
    heroTitle: "ভাইরাল কন্টেন্ট তৈরি করুন",
    ...
    quotaExhausted: "দৈনিক এপিআই কোটা শেষ হয়ে গেছে। অনুগ্রহ করে আগামীকাল চেষ্টা করুন অথবা সেটিংসে আপনার নিজস্ব এপিআই কী ব্যবহার করুন।",
    ...
    popularCategories: "জনপ্রিয় বিভাগ (১০ টি বিষয়)",
    liveInsights: "লাইভ ক্রিয়েটর ইনসাইটস",
    processingPower: "এআই কম্পিউট পাওয়ার",
    threatLevel: "নয়েজ ইন্টারফেয়ারেন্স লেভেল",
    uptime: "সিস্টেম আপটাইম",
    generatingInsight: "গ্লোবাল ট্রেন্ডের সাথে সিংকিং...",
    ...
    audience: "টার্গেট দর্শক",
    audienceGeneral: "সাধারণ দর্শক",
    audienceKids: "শিশু ও পরিবার",
    audienceTech: "টেক উৎসাহী",
    audienceBusiness: "ব্যবসায়ী ব্যক্তিত্ব",
    audienceCreative: "সৃজনশীল মেধা",
    pacing: "কন্টেন্ট পেসিং",
    pacingFast: "দ্রুত ও প্রাণবন্ত",
    pacingSteady: "ভারসাম্যপূর্ণ",
    pacingRelaxed: "ধীর ও শান্ত",
    narrativeStrategy: "বর্ণনা কৌশল",
    strategyEducational: "শিক্ষামূলক",
    strategyStorytelling: "গল্প বলা",
    strategyInterview: "সাক্ষাৎকার স্টাইল",
    strategyFirstPerson: "ফার্স্ট পারসন ভ্লগ",
    strategyListicle: "লিস্টিকল / টপ ১০",
    deepSearch: "ডিপ এআই কনটেক্সট সার্চ",
    settings: "সেটিংস",
