...
Return the result as a JSON object with a key 'prompts' which is an array of strings.`;
        ...
        if (currentSelectedMedia && (mediaMimeType.startsWith('audio/') || mediaMimeType.startsWith('video/'))) {
          ...
          const res = await generateVoiceExtractor(currentSelectedMedia, mediaMimeType, targetLang, topics.voiceExtractor);
          setResults(prev => ({ ...prev, [activeView]: res }));
        ...
        if (currentView === 'image' || currentView === 'video' || currentView === 'voiceExtractor') {
          ...
          try {
            ...
            if (currentView === 'voiceExtractor') {
              res = await generateVoiceExtractor(base64, file.type, options.language as 'en' | 'bn' | 'hi', topics.voiceExtractor);
              ...
              <div className="space-y-2">
                <label className="text-xs uppercase tracking-widest text-slate-500 font-bold flex items-center gap-2">
                  <FileText size={14} /> {
                    ...
                    currentView === 'voiceExtractor' ? (uiLang === 'en' ? "Additional Instructions (Optional)" : "অতিরিক্ত নির্দেশনা (ঐচ্ছিক)") :
                    t.topicInput
                  }
                </label>
                <div className="relative w-full">
                  <textarea 
                    placeholder={
                      ...
                      currentView === 'voiceExtractor' ? (uiLang === 'en' ? "e.g., Focus on the technical details, or summarize for a beginner..." : "যেমন: প্রযুক্তিগত বিবরণে ফোকাস করুন, অথবা একজন নতুনদের জন্য সারসংক্ষেপ করুন...") :
                      t.topicPlaceholder
                    }
                ...
                <div className="flex-1 flex flex-col items-center justify-center text-center p-8 space-y-6">
                  ...
                  <div className="grid grid-cols-2 gap-4 w-full pt-8">
                    {[
                      ...
                      { label: t.voiceExtractor, icon: AudioLines, view: 'voiceExtractor' }
                    ].map((item, i) => (
                      <button 
                        key={i}
                        onClick={() => {
